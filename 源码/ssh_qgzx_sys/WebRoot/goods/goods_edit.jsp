	...
	<table cellspacing="1" cellpadding="0" width="98%" align="center"
		...
		<tr>
			<td colspan="4" align="left" class="bkuang zi13b bgcolor2 padl5">
				<bean:message key='goods.title.info' bundle="label" />
			</td>
		</tr>
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" value="${goods.name}" id="name" name="goods.name" maxlength="30"
					clazz="box1" />
				&nbsp;
				<font color="red">*</font>
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text"  value="${goods.beizhu" name="goods.beizhu"
