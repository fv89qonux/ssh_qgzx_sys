	...
	<table cellspacing="1" cellpadding="0" width="98%" align="center"
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="text" id="name" value="${loginuser.name}"
					name="loginuser.name" maxlength="30" clazz="box1" />
			...
			<td width="30%" class="pad2 zi13">
				...
				<input type="password" id="password" value="${loginuser.password}"
					name="loginuser.password" maxlength="50" clazz="box1" />
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13" colspan="3">
				...
				<input type="text" id="rname" name="loginuser.rname"
					value="${loginuser.rname}" maxlength="30" clazz="box1" />
				&nbsp;
				<font color="red">*</font>
		...
		<tr class="bgcolor">
			...
			<td width="30%" class="pad2 zi13" colspan="3">
				...
				<input type="text" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',readOnly:true})" id="renzhi" name="loginuser.renzhi"
