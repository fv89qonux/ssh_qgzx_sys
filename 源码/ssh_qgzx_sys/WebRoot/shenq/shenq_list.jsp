...
<form name="form1" action="shenq!queryShenq.action"
	method="post">
			...
			<td>
				<fmt:bundle basename="global_resources">
					<display:table style="width:100%; text-align:center;"
                        ...
                        <display:column title="审批状态" sortable="true"
							style="width:15%; text-align:center;">
                           ${shenq.shenpi}
                        </display:column>
                        <c:if
                        ...
                        <display:column title="操作" sortable="true"
							style="width:15%; text-align:center;">
							<c:if test="${shenq.shenpi=='提交申请'}">
							  <a href="<%=path%>/shenq!xscShenq.action?id=${shenq.id}&xscsp=ty">同意</a>
							  <a href="<%=path%>/shenq!xscShenq.action?id=${shenq.id}&xscsp=bty">不同意</a>
							  </c:if>
                        </display:column>
</c:if>
					</display:table>
