			...
			<td>
				<fmt:bundle basename="global_resources">
					<display:table style="width:100%; text-align:center;"
						...
						<display:column title="学生处审批" sortable="true"
						...
						<display:column title="操作" sortable="true"
							style="width:15%; text-align:center;">
							<c:if test="${shenq.shenpi=='审批中'}">
								<a href="<%=path%>/shenq!dwShenq.action?id=${shenq.id}&xscsp=ty">同意</a>
								<a
									href="<%=path%>/shenq!dwShenq.action?id=${shenq.id}&xscsp=bty">不同意</a>
							</c:if>
						</display:column>
